...
For background colors, I defaulted to color of original branding with some liberties taken.  WonderSwan I didn't want to just be another red, so I pulled a color from the more recent Namco Bandai logo.  For 3DO, I just used the only color from the original console that wasn't just grey or black.  There was some method to the madness, but only so much.
